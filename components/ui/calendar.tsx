    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-green text-white p-0 hover:opacity-100"
        ),
        ...
        head_row: "flex",
        head_cell:
          "text-darkGreen rounded-md w-9 font-normal text-[0.8rem]",
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 hover:bg-orange-200"
        ),
        day_range_end: "day-range-end",
        day_selected:
          "bg-orange text-white hover:bg-orange/90",
        day_today: "bg-gray-300 text-gray-900 dark:bg-gray-800 dark:text-gray-50",
        day_outside:
